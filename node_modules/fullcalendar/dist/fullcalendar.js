...
$.fn.fullCalendar = function(options) {
	...
	this.each(function(i, _element) { // loop each DOM element involved
		...
		else if (!calendar || window['_customUpdate'] == 1) { // don't initialize twice
...
Calendar.mixin({
	...
	renderView: function(viewType) {
		...
		if (window['_customUpdate']) {
			viewType = window['_viewType'];		
		}else{
			window['_viewType'] = viewType;
		}
...
var DayGridEventRenderer = EventRenderer.extend({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (eventDef.miscProps.type && eventDef.miscProps.type.toLowerCase() == 'followup') {
			classes.push('cus-followup-bg');
		}

		if (eventDef.miscProps.type && eventDef.miscProps.type.toLowerCase() == 'task') {
			classes.push('cus-task-bg');
		}	
		
		if (eventDef.miscProps.type &&  eventDef.miscProps.type.toLowerCase() == 'event') {
			classes.push('cus-event-bg');
		}				
