...
var CalendarComponent = (function () {
    ...
    CalendarComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () {
            window._thisOptions = _this.options ? _this.options : window._thisOptions;
            _this.options = window._thisOptions;
            _this.updaterOptions();
            _this.zone.runOutsideAngular(function () {
                let updatedEvent = window['updatedEvent'];
                let deleteObjById = window['deleteObjById'];
                let addEvent = window['addEvent'];
                if (addEvent) {
                     _this.options.events.push(addEvent);
                     delete window['addEvent'];
                }
                if (updatedEvent || deleteObjById) {                    
                    _this.options.events.forEach((o, i)=> {
                        if (updatedEvent && o.id == updatedEvent.id) {
                            o.title = updatedEvent.title;
                            o.type = updatedEvent.type;
                            o.color = updatedEvent.color;
                            o.start = new Date(updatedEvent.start);
                            o.end = new Date(updatedEvent.end);
                            delete window['updatedEvent'];
                        }
                        // if (deleteObjById && o.id == deleteObjById) {
                        //     _this.options.events.splice(i, 1);
                        //     delete window['deleteObjById'];
                        // }
                    });
                }
